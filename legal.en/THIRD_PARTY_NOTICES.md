...
| web3-utils@1.10.4 | LGPL-3.0 | Weak copyleft; do not modify without publishing changes |
...
| Package | License | Note |
|-------|----------|------------|
| dompurify@3.3.1 | (MPL-2.0 OR Apache-2.0) | File-level copyleft if library files are modified |
