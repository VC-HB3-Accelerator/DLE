**English** | [Русский](../legal.ru/THIRD_PARTY_NOTICES.md)
...
| Package | License | Note |
|-------|----------|------------|
| @ethereumjs/rlp@4.0.1 | MPL-2.0 | File-level copyleft if library files are modified |
| @ethereumjs/rlp@5.0.2 | MPL-2.0 | File-level copyleft if library files are modified |
| @ethereumjs/util@8.1.0 | MPL-2.0 | File-level copyleft if library files are modified |
| @ethereumjs/util@9.1.0 | MPL-2.0 | File-level copyleft if library files are modified |
| @zone-eu/mailsplit@5.4.8 | (MIT OR EUPL-1.1+) | Dual MIT/EUPL; if modified — EUPL terms apply |
| chai-as-promised@7.1.2 | WTFPL | Comply with license terms |
...
| Package | License | Note |
|-------|----------|------------|
| dompurify@3.4.11 | (MPL-2.0 OR Apache-2.0) | File-level copyleft if library files are modified |
