...
- 🤖 **[Настройка AI Ассистента](docs/setup-ai-assistant.md)** - создание базы знаний и автоматизация через электронные таблицы
- 💼 **[Блокчейн для бизнеса](docs/blockchain-for-business.md)** - как блокчейн решает бизнес-задачи, токенизация активов
- 🤖 **[AI Ассистент - полное описание](docs/ai-assistant.md)** - второй пилот для команды
...
### ✅ Все обновления бесплатны 5 лет для держателей лицензионных токенов (см. `legal/service-terms.md`)
