[English](https://hb3-accelerator.com/gitea/VC-HB3-Accelerator/Docs/src/branch/main/legal.en/AUTHORS.md) | **Русский**
...
- **Общество с ограниченной ответственностью "ЭРАЙТИ" (ООО "ЭРАЙТИ")**  
  - **Роль:** Официальный продавец и партнер по лицензированию для клиентов из Российской Федерации  
...
- **2024-2026:** Разработка и выпуск первой версии DLE
