...
**Статус:** служебная карта каталога, не корпус и не источник для векторного индекса. Отдельно индексируются только три международных шаблона для аудитории `partner`. Формы из `rf-eraity/` в индекс не входят.

**Правило для ассистента:** это незаполненные модельные документы, а не подписанные договоры. Поля `[…]`, стороны, реквизиты, цены, налоги, адреса кошельков, подписи, применимое право и суд нельзя выдавать как согласованные факты.
...
**Локализация РФ (ООО «ЭРАЙТИ»):** [rf-eraity/](rf-eraity/) — рабочие заполненные тексты для ОС контрибьютора.

---

**© 2024-2026 Тарабанов Александр Викторович**  
**Обновление:** 2026-08-06
