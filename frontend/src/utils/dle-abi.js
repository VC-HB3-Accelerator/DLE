...
export const DLE_ABI = [
  ...
  "function getProposalSummary(uint256 _proposalId) returns (uint256, string, uint256, uint256, bool, bool, uint256, address, uint256, uint256[])",
  "function getProposalsCount() returns (uint256)",
  ...
  "function peerContracts(uint256) returns (address)",
  "function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s)",
  "function proposalCounter() returns (uint256)",
  "function proposalExecutedInChain(uint256, uint256) returns (bool)",
  "function proposals(uint256) returns (uint256, string, uint256, uint256, bool, bool, uint256, address, bytes, uint256)",
