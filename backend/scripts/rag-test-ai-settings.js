...
const LANGUAGE_CLAUSE_NEXT = '7) Язык ответа — язык последнего сообщения пользователя (русский или английский). Канон «кто мы», официальное имя «VC HB3 Accelerator», тарифы и цифры из источников этого сообщения — дословно, без вольного перевода и без сжатия в слоган. Служебные ярлыки DLE / ОС / ask / DEAL в ответе клиенту не копируйте — только формулировки глоссария («Говорить клиенту»). Остальной текст — на языке пользователя. Без иероглифов. В русском тексте латиница только в устоявшихся именах (VC HB3 Accelerator) и адресе сайта.';
