 ...
 * Источник: документация QwenCloud Voice list (speech output).
 */

const CONFERENCE_SPEECH_LANGUAGES = Object.freeze([
...
function isConferenceSpeechLanguage(code) {
...
function normalizeConferenceSpeechLanguage(value, fallback = 'en') {
...
module.exports = {
  CONFERENCE_SPEECH_LANGUAGES,
  SPEECH_LANG_CODES,
  isConferenceSpeechLanguage,
